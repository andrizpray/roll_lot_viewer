      ...
      <div class="modal-body">
        <div class="detail-grid">
          <div class="detail-item">
            <label>Lot ID</label>
            <span class="val-lotid">{{ sheet.lot_id }}</span>
          </div>
          <div class="detail-item">
            <label>Item ID</label>
          ...
          <div class="detail-item">
            <label>Weight</label>
            <span class="val-weight">{{ sheet.weight }} kg</span>
          </div>
          <div class="detail-item">
          ...
          <div class="detail-item">
            ...
            <span class="val-muted">{{ sheet.content_pack ?? '-' }}</span>
          </div>
          <div class="detail-item">
            <label>Content Pallet</label>
            <span class="val-muted">{{ sheet.content_pallet ?? '-' }}</span>
          </div>
          <div class="detail-item">
          ...
          <div class="detail-item full-width">
            ...
            <span class="val-desc">{{ sheet.description_raw || '-' }}</span>
          </div>
        </div>
      </div>
    </div>
